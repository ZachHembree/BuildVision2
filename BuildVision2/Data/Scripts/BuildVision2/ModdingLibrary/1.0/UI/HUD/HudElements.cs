...
namespace DarkHelmet.UI
{
    ...
    public class TexturedBox : ResizableElementBase
    {
        ...
        public TexturedBox(HudNodeBase parent = null) : base(parent)
        {
    ...
    {
        public RichTextBoard Text { get; set; }
        public TextAlignment TextAlignment { get { return Text.Alignment; } set { Text.Alignment = value; } }
        public override Vector2 Size => Text.TextSize;

        public RichTextElement(HudNodeBase parent = null, bool wordWrapping = false) : base(parent)
        {
            Text = new RichTextBoard(wordWrapping);
        }
    ...
    public class TextHudMessage : HudElementBase
    {
        ...
        public TextHudMessage(HudNodeBase parent = null) : base(parent)
        {
        ...
        protected override void Draw()
        {
            if (hudMessage == null)
            {
                hudMessage = new HudAPIv2.HUDMessage
                {
                    ...
                    Scale = Scale * HudMain.InvTextApiScale,
            ...
            hudMessage.Scale = Scale * HudMain.InvTextApiScale;
            UpdateTextOffset();
    ...
    public class BoxChain : HudElementBase
    {
        ...
        public BoxChain(List<ResizableElementBase> elements, HudNodeBase parent = null, bool alignVertical = true, float spacing = 0f) : base(parent)
        {
    ...
    {
        public TextAlignment TextAlignment { get { return textElement.Text.Alignment; } set { textElement.Text.Alignment = value; } }
        public GlyphFormat DefaultFormat { get { return textElement.Text.Format; } set { textElement.Text.Format = value; } }
        ...
        public RichTextBoard Text { get { return textElement.Text; } set { textElement.Text = value; } }
        public IReadonlyHudElement TextElement => textElement;

        private readonly RichTextElement textElement;

        public TextBox(HudNodeBase parent = null) : base(parent)
        {
    ...
    public class DoubleTextBox : TextBoxBase
    {
        ...
        public RichTextBoard LeftText { get { return left.Text; } set { left.Text = value; } }
        public RichTextBoard RightText { get { return right.Text; } set { right.Text = value; } }
        public IReadonlyHudElement Left => left;
        public IReadonlyHudElement Right => Right;

        private readonly RichTextElement left, right;

        public DoubleTextBox(HudNodeBase parent = null) : base(parent)
        {
            left = new RichTextElement(this) { TextAlignment = TextAlignment.Left, ParentAlignment = ParentAlignment.Left };
            right = new RichTextElement(this) { TextAlignment = TextAlignment.Right, ParentAlignment = ParentAlignment.Right };
        }
    ...
    public class TextList : HudElementBase
    {
        ...
        public TextList(int capacity, HudNodeBase parent = null) : base(parent)
        {
    ...
    public class ListBox : TextBoxBase
    {
        ...
        public ListBox(int maxListLength, HudNodeBase parent = null) : base(parent)
        {
