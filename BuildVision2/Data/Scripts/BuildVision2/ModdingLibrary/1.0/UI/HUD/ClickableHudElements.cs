...
namespace DarkHelmet.UI
{
    public class ClickableElement : ResizableElementBase, IReadonlyClickableElement
    {
        ...
        public ClickableElement(HudNodeBase parent = null) : base(parent)
        {
            CaptureCursor = true;
        }
    ...
    public class Button : TexturedBox
    {
        ...
        public Button(HudNodeBase parent = null) : base(parent)
        {
    ...
    public class TextButton : TextBox
    {
        ...
        public TextButton(HudNodeBase parent = null) : base(parent)
        {
            mouseInput = new ClickableElement(this);
            highlightColor = new Color(255, 255, 255, 125);
            highlightEnabled = true;
    ...
    {
        public RichTextBoard Title { get { return header.Text; } set { header.Text = value; } }
        ...
        public Window(HudNodeBase parent = null) : base(parent)
        {
            CaptureCursor = true;
            AllowResizing = true;
    ...
    public class ScrollBar : ResizableElementBase
    {
        ...
        public ScrollBar(HudNodeBase parent = null) : base(parent)
        {
            CaptureCursor = true;
            ShareCursor = false;
