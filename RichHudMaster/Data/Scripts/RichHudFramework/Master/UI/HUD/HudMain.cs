    ...
    namespace UI.Server
    {
        ...
        public sealed partial class HudMain : ModBase.ComponentBase
        {
            ...
            public static TextBoardMembers GetTextBoardData(bool wordWrapping) =>
                new TextBoard(wordWrapping).GetApiData();
            ...
            public static HudMainMembers GetApiData()
            {
                ...
                return new HudMainMembers()
                {
                    ...
                    Item6 = new MyTuple<Func<float>, Func<float>, Func<float>, MyTuple<Func<IList<RichStringMembers>>, Action<IList<RichStringMembers>>>, Func<bool, TextBoardMembers>>
                    {
                        Item1 = () => ResScale,
                        Item2 = () => instance.fov,
